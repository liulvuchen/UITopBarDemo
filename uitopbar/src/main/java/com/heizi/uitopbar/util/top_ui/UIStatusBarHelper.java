 ...
 * className: UIStatusBarHelper
 * createTime: 2018/11/20 15:59
 */
public class UIStatusBarHelper {
    ...
    private static boolean supportTranslucent() {
        return Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT
                ...
                && !(PhoneDeviceHelper.isEssentialPhone() && Build.VERSION.SDK_INT < 26);
    }
    ...
    public static void translucent(Window window, @ColorInt int colorOn5x) {
        ...
        // 小米和魅族4.4 以上版本支持沉浸式
        if (PhoneDeviceHelper.isMeizu() || PhoneDeviceHelper.isMIUI()) {
...
//            }
    ...
    public static boolean setStatusBarLightMode(Activity activity) {
        ...
        if (PhoneDeviceHelper.isZTKC2016()) {
            return false;
        }
    ...
    private static boolean isMIUICustomStatusBarLightModeImpl() {
        if (PhoneDeviceHelper.isMIUIV9() && Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            return true;
        }
        return PhoneDeviceHelper.isMIUIV5() || PhoneDeviceHelper.isMIUIV6() ||
                PhoneDeviceHelper.isMIUIV7() || PhoneDeviceHelper.isMIUIV8();
    }
    ...
    public static boolean supportTransclentStatusBar6() {
        return !(PhoneDeviceHelper.isZUKZ1() || PhoneDeviceHelper.isZTKC2016());
    }
    ...
    private static void initStatusBarHeight(Context context) {
        ...
        if (PhoneDeviceHelper.isTablet(context)
