...
/**
 * describe: 电量栏适配(刘海屏挖空适配)
 * authors: heizi
 * email: 2867058917@qq.com
 * className: UINotchHelper
 * createTime: 2018/11/20 17:33
 */
...
public class UINotchHelper {
    ...
    public static boolean has3rdNotch(Context context){
        if (PhoneDeviceHelper.isHuawei()) {
            return hasNotchInHuawei(context);
        } else if (PhoneDeviceHelper.isVivo()) {
            return hasNotchInVivo(context);
        } else if (PhoneDeviceHelper.isOppo()) {
            return hasNotchInOppo(context);
        } else if (PhoneDeviceHelper.isXiaomi()) {
    ...
    private static Rect getRectInfoRotation0(Context context) {
        ...
        if (PhoneDeviceHelper.isVivo()) {
            ...
            rect.bottom = 0;
        } else if (PhoneDeviceHelper.isHuawei()) {
    ...
    public static int getNotchHeightInXiaomi(Context context) {
        ...
        return UIStatusBarHelper.getStatusbarHeight(context);
    }
    ...
    public static boolean needFixLandscapeNotchAreaFitSystemWindow(View view){
        return PhoneDeviceHelper.isXiaomi() && UINotchHelper.hasNotch(view);
    }
}
