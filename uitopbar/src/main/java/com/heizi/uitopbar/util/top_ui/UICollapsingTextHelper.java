...
public final class UICollapsingTextHelper {
    ...
    public void setCollapsedTextAppearance(int resId) {
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(mView.getContext(), resId, R.styleable.UITextAppearance);
    ...
    public void setExpansionFraction(float fraction) {
        fraction =LangHelper.constrain(fraction, 0f, 1f);
