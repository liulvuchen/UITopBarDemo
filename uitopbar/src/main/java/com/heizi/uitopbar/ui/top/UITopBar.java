...
/**
 * describe: 通用的顶部 Bar。提供了以下功能：在左侧/右侧添加图片按钮/文字按钮/自定义,
...
public class UITopBar extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTopBarSeparatorColor = array.getColor(R.styleable.UITopBar_ui_topbar_separator_color, Color.WHITE);
    ...
    void getCommonFieldFormTypedArray(Context context, TypedArray array) {
        mLeftBackDrawableRes = array.getResourceId(R.styleable.UITopBar_ui_topbar_left_back_drawable_id, R.mipmap.ic_top_bar);
        ...
        mTitleTextColor = array.getColor(R.styleable.UITopBar_ui_topbar_title_color, ContextCompat.getColor(context,R.color.c_222));
        mSubTitleTextColor = array.getColor(R.styleable.UITopBar_ui_topbar_subtitle_color, getAttrColor(context, R.attr.ui_config_color_gray_4));
...
//            mTitleView = isEmoji ? new EmojiconTextView(getContext()) : new TextView(getContext());
    ...
    private LayoutParams generateTitleContainerViewLp() {
        return new LayoutParams(LayoutParams.MATCH_PARENT,
             getAttrDimen(getContext(), R.attr.ui_topbar_height));
    }
    ...
    public AppCompatImageButton addRightImageButton(int drawableResId, int viewId) {
        AppCompatImageButton rightButton = generateTopBarImageButton(drawableResId);
    ...
    public AppCompatImageButton addLeftImageButton(int drawableResId, int viewId) {
        AppCompatImageButton leftButton = generateTopBarImageButton(drawableResId);
     ...
     */
    private AppCompatImageButton generateTopBarImageButton(int imageResourceId) {
        AppCompatImageButton backButton = new AppCompatImageButton(getContext());
    ...
    private int getTopBarHeight() {
        if (mTopbarHeight == -1) {
            mTopbarHeight =getAttrDimen(getContext(), R.attr.ui_topbar_height);
        }
    ...
    private static int getAttrColor(Context context, int attrRes){
