...
import com.heizi.uitopbar.util.top_ui.UIWindowInsetHelper;
 ...
 * className: UIWindowInsetLayout
 * createTime: 2018/11/20 17:36
 */
public class UIWindowInsetLayout extends ConstraintLayout implements IWindowInsetLayout {
    private UIWindowInsetHelper mQMUIWindowInsetHelper;
    ...
    public UIWindowInsetLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mQMUIWindowInsetHelper = new UIWindowInsetHelper(this, this);
    }
