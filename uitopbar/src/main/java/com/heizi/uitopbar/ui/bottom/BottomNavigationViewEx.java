package com.heizi.uitopbar.ui.bottom;
...
/**
 * describe: BottomNavigationView实现类（实现底部图片/数字标签）
 * 适配api28 setShiftingMode属性改变
 * authors: heizi
 * email: 2867058917@qq.com
 * className: BottomNavigationViewEx
 * createTime: 2018/11/16 14:12
 */
