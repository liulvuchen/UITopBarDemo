...
import com.heizi.uitopbar.util.LangHelper;
import com.heizi.uitopbar.util.top_ui.UICollapsingTextHelper;
import com.heizi.uitopbar.util.top_ui.UIInterpolatorStaticHolder;
import com.heizi.uitopbar.util.top_ui.UIViewHelper;
import com.heizi.uitopbar.util.top_ui.UIViewOffsetHelper;
...
/**
 * describe:  参考 {@link android.support.design.widget.CollapsingToolbarLayout}, 适配 UITopBar
 * authors: heizi
 * email: 2867058917@qq.com
 * className: UICollapsingTopBarLayout
 * createTime: 2018/11/20 17:32
 */

public class UICollapsingTopBarLayout extends ConstraintLayout implements IWindowInsetLayout {
...
//            mTmpRect.top = mTmpRect.top - topBarInsetAdjustTop;
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof UICollapsingTopBarLayout.LayoutParams;
    }

    @Override
    protected UICollapsingTopBarLayout.LayoutParams generateDefaultLayoutParams() {
        return new UICollapsingTopBarLayout.LayoutParams(UICollapsingTopBarLayout.LayoutParams.MATCH_PARENT, UICollapsingTopBarLayout.LayoutParams.MATCH_PARENT);
    }

    @Override
    public ConstraintLayout.LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new UICollapsingTopBarLayout.LayoutParams(getContext(), attrs);
    }

    @Override
    protected ConstraintLayout.LayoutParams generateLayoutParams(ViewGroup.LayoutParams p) {
        return new UICollapsingTopBarLayout.LayoutParams(p);
    }
    ...
    public boolean applySystemWindowInsets19(Rect insets) {
        ...
        if (!LangHelper.objectEquals(mLastInsets, newInsets)) {
    ...
    final int getMaxOffsetForPinChild(View child) {
        ...
        final UICollapsingTopBarLayout.LayoutParams lp = (UICollapsingTopBarLayout.LayoutParams) child.getLayoutParams();
        return getHeight()
        ...
        public void onOffsetChanged(AppBarLayout layout, int verticalOffset) {
            ...
            for (int i = 0, z = getChildCount(); i < z; i++) {
                ...
                switch (lp.mCollapseMode) {
                    case UICollapsingTopBarLayout.LayoutParams.COLLAPSE_MODE_PIN:
                        offsetHelper.setTopAndBottomOffset(
                                LangHelper.constrain(-verticalOffset, 0, getMaxOffsetForPinChild(child)));
                        break;
                    case UICollapsingTopBarLayout.LayoutParams.COLLAPSE_MODE_PARALLAX:
                        offsetHelper.setTopAndBottomOffset(
