package com.heizi.uitopbar.dialog;
...
/**
 * describe: 用于显示 Loading 的 ，支持颜色和大小的设置。
 * authors: heizi
 * email: 2867058917@qq.com
 * className: UILoadingView
 * createTime: 2018/11/20 14:52
 */
public class UILoadingView extends View {
    ...
    public UILoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSize = array.getDimensionPixelSize(R.styleable.UILoadingView_ui_loading_view_size, dp2px(context, 5));
